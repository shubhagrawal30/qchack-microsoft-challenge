...
if len(arg_list) < 1:
    ...
    # and recording time it takes each protocol to run
    for i in log_e_dom:
        e_prec = 10.0 ** (-1 * i)
    ...
    # Plotting result of run time for each protocol against the precision value used
    # in that run
    ...
    # Plotting result of the number of gates generated by each protocol against the precision value used
    # in that run
    ...
    # and recording the time it takes each protocol to run
    ...
    # Plotting result of run time for each protocol against the simulation time used
    # in that run
    ...
    # Plotting result of the number of gates generated by the protocol against the simulation time used
    # in that run
